...
![](V:\Asa\Dummy-Robot\5.Docs\1.Images\cycliod-nano.jpg)
...
![](V:\Asa\Dummy-Robot\5.Docs\1.Images\fw2.png)
...
![](V:\Asa\Dummy-Robot\5.Docs\1.Images\fw3.png)
...
![](V:\Asa\Dummy-Robot\5.Docs\1.Images\fw1.jpg)

其中驱动器信息包含：CAN节点ID、**是否反向**、减速器的减速比、**运动限制范围**。

而DH参数的含义如下：

![](V:\Asa\Dummy-Robot\5.Docs\1.Images\fw2.jpg)
